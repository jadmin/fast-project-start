...
test('inherited - three levels', function (assert) {
  ...
  var inst = new DecoratedClass('templates.ops.test');
  ...
  assert.strictEqual(inst.baseTestArgument, 'templates.ops.test');
  assert.strictEqual(inst.middleTestArgument, 'templates.ops.test');
  assert.strictEqual(inst.decoratorTestArgument, 'templates.ops.test');

  var out = inst.test('templates.ops.test');
