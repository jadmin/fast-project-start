...
module.exports = function (grunt) {
  ...
  grunt.registerTask('templates.ops.test', testSubtasks);
  ...
  // Default task.
  grunt.registerTask('default', ['clean:dist', 'copy:fonts', 'templates.ops.test']);
